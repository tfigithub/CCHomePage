...
<!-- START FOOTER TOP-->
		<section class="footer-top section-padding">	
			<div class="container">
				<div class="row">					
					<div class="col-md-12 col-sm-6  wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s" data-wow-offset="0">
						<div class="single_footer">
							<h4 style="text-align:center; font-size:36px;">About us</h4>
		...
		<!-- START FOOTER -->
		<footer class="footer section-padding" style="padding:30px 0;">
			<div class="container">
				<div class="row">
					<div class="col-sm-10 text-center">	
						<div class="footer-content">
							...
							<p class="footer_copyright" style="color:#000;">&copy; Technical Frontiers, Inc. All Rights Reserved.</p>
						</div>
					</div><!--- END COL -->
					<div class="col-sm-2" style="top:120px;">
						<img src="assets/img/logo_tf.png" width="100%" />
					</div>
				</div><!--- END ROW -->
			</div><!--- END CONTAINER -->			
		</footer>
